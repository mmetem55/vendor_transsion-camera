...
.field private mVideoPlayerProxy:Lcom/unity3d/player/p;
...
.method public constructor <init>(Landroid/content/Context;Lcom/unity3d/player/IUnityPlayerLifecycleEvents;)V
    ...
    iget-object p0, p0, Lcom/unity3d/player/UnityPlayer;->m_MainThread:Lcom/unity3d/player/UnityPlayer$g;
...
.method static synthetic access$3702(Lcom/unity3d/player/UnityPlayer;Lcom/unity3d/player/p;)Lcom/unity3d/player/p;
    .locals 0

    iput-object p1, p0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/p;
...
.method static synthetic access$4200(Lorg/json/JSONObject;)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$4300(Lcom/unity3d/player/UnityPlayer;)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$4400(Lcom/unity3d/player/UnityPlayer;)Landroid/os/Handler;
    .locals 0
...
.method static synthetic access$4500(Lcom/unity3d/player/UnityPlayer;)I
    .locals 0
...
.method private checkResumePlayer()V
    ...
    invoke-virtual {v1, v0}, Lcom/unity3d/player/n;->e(Z)Z
    ...
    invoke-virtual {p0}, Lcom/unity3d/player/UnityPlayer$g;->b()V
...
.method private generateSplashView(Landroid/content/Context;)Lcom/unity3d/player/k;
    ...
    invoke-virtual {p1, v2}, Lcom/unity3d/splash/services/core/misc/JsonStorage;->get(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v2}, Lcom/unity3d/splash/services/core/misc/JsonStorage;->delete(Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v0}, Lcom/unity3d/splash/services/core/misc/JsonStorage;->get(Ljava/lang/String;)Ljava/lang/Object;
    ...
    :catch_1
    :cond_2
    const-string p0, "splash show nothing"
...
.method private getSplashGameId()Ljava/lang/String;
    ...
    const-string v0, "unity.splash-ads-game-id"
...
.method private registerLaunch()V
    ...
    :cond_0
    iput-boolean v1, p0, Lcom/unity3d/player/UnityPlayer;->shouldShowLaunchScreenAds:Z

    sget-object v0, Lcom/unity3d/player/UnityPlayer;->currentActivity:Landroid/app/Activity;

    const/4 v4, 0x0

    invoke-static {v0, v3, v4}, Lcom/unity3d/splash/UnityAds;->initialize(Landroid/app/Activity;Ljava/lang/String;Lcom/unity3d/splash/IUnityAdsListener;)V
...
.method private sendSurfaceChangedEvent()V
    ...
    invoke-virtual {p0, v0}, Lcom/unity3d/player/UnityPlayer$g;->d(Ljava/lang/Runnable;)V
...
.method private shutdown()V
    ...
    iget-object p0, p0, Lcom/unity3d/player/UnityPlayer;->mState:Lcom/unity3d/player/n;

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lcom/unity3d/player/n;->c(Z)V
...
.method private updateDisplayInternal(ILandroid/view/Surface;)Z
    ...
    invoke-virtual {p0, v1}, Lcom/unity3d/player/UnityPlayer$g;->b(Ljava/lang/Runnable;)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, v1}, Lcom/unity3d/player/UnityPlayer$g;->c(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, p0, p1, v1}, Ljava/util/concurrent/Semaphore;->tryAcquire(JLjava/util/concurrent/TimeUnit;)Z

    move-result p0

    if-nez p0, :cond_3

    const-string p0, "Timeout while trying detaching primary window."
    ...
    :catch_0
    const-string p0, "UI thread got interrupted while trying to detach the primary window from the Unity Engine."
...
.method public NotifySplashAdsFinished()V
    ...
    invoke-virtual {p0}, Lcom/unity3d/player/UnityPlayer$g;->f()V
...
.method public configurationChanged(Landroid/content/res/Configuration;)V
    ...
    :cond_0
    iget-object p0, p0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/p;
...
.method protected disableLogger()V
    ...
    sput-boolean p0, Lcom/unity3d/player/f;->a:Z
...
.method protected getKeyboardLayout()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/unity3d/player/UnityPlayer;->mSoftInputDialog:Lcom/unity3d/player/i;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/unity3d/player/i;->a()Ljava/lang/String;
...
.method protected getShowSplashSlogan()Ljava/lang/Boolean;
    ...
    const-string v0, "unity.splash-ads-slogan"
...
.method protected getShowSplashSloganHeight()I
    ...
    const-string v0, "unity.splash-ads-slogan-height"
...
.method public isLaunchScreenAdsFinished()Z
    ...
    iget-boolean p0, p0, Lcom/unity3d/player/UnityPlayer;->finishLaunchScreenAds:Z
...
.method public newIntent(Landroid/content/Intent;)V
    ...
    invoke-virtual {p0}, Lcom/unity3d/player/UnityPlayer$g;->e()V
...
.method public pause()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/p;
...
.method protected requestUserAuthorization(Ljava/lang/String;)V
    ...
    new-instance p0, Lcom/unity3d/player/UnityPermissions$ModalWaitForPermissionResponse;

    invoke-direct {p0}, Lcom/unity3d/player/UnityPermissions$ModalWaitForPermissionResponse;-><init>()V
    ...
    invoke-static {v0, v1, p0}, Lcom/unity3d/player/UnityPermissions;->requestUserPermissions(Landroid/app/Activity;[Ljava/lang/String;Lcom/unity3d/player/IPermissionRequestCallbacks;)V

    invoke-virtual {p0}, Lcom/unity3d/player/UnityPermissions$ModalWaitForPermissionResponse;->waitForResponse()V
...
.method protected showVideoPlayer(Ljava/lang/String;IIIZII)Z
    ...
    iget-object v1, v0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/p;
    ...
    iput-object v1, v0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/p;

    :cond_0
    iget-object v2, v0, Lcom/unity3d/player/UnityPlayer;->mVideoPlayerProxy:Lcom/unity3d/player/p;
...
.method public startOrientationListener(I)Z
    ...
    :goto_0
    invoke-static {v2, p0}, Lcom/unity3d/player/f;->Log(ILjava/lang/String;)V
